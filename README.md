...
一个运行在 Delta Chat 中的联系人网络机器人，适合约 150 人的小型社群。成员只需私聊机器人，即可通过加入码进入联系网络、按昵称查找成员，并把自己的 Delta Chat 联系人名片发送给对方。

机器人支持多个相互隔离的联系网络。成员可以同时加入多个网络，网络管理员负责成员和加入码，系统管理员负责创建网络及分配管理员权限。
